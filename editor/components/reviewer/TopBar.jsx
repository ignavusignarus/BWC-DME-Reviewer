...
export default function TopBar({ manifest, source, onBack, onSelectSource }) {
    ...
    return (
        <div role="banner" data-testid="topbar" style={{ display: 'flex', gap: 14, alignItems: 'center', padding: '8px 14px', background: '#161b22', borderBottom: '1px solid #21262d' }}>
            ...
            <select
                ...
                style={{ background: '#0d1117', color: '#c9d1d9', border: '1px solid #30363d', borderRadius: 3, padding: '4px 9px', fontSize: '0.78rem', fontFamily: 'ui-monospace, monospace', minWidth: 280 }}
            >
